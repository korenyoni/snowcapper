...
func TestConfigSha384(t *testing.T) {
	config := `
packages:
  - name: vault
    binaries:
      - name: vault
        mode: 0755
        src: https://releases.hashicorp.com/vault/0.10.0/vault_0.10.0_linux_amd64.zip
        src_hash: 123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456 
        format: zip
    files:
      - path: /etc/vault/config.hcl
        mode: 0700
  ...
  - name: vault
    binaries:
      - name: vault
        mode: 0755
        src: https://releases.hashicorp.com/vault/0.10.0/vault_0.10.0_linux_amd64.zip
        src_hash: 1234567890123456789012345678901234567890123456789012345678901234 
        format: zip
    files:
      - path: /etc/vault/config.hcl
        mode: 0700
...
func TestConfigSha224(t *testing.T) {
	config := `
packages:
  - name: vault
    binaries:
      - name: vault
        mode: 0755
        src: https://releases.hashicorp.com/vault/0.10.0/vault_0.10.0_linux_amd64.zip
        src_hash: 12345678901234567890123456789012345678901234567890123456
        format: zip
    files:
      - path: /etc/vault/config.hcl
        mode: 0700
...
func TestConfigSha1(t *testing.T) {
	config := `
packages:
  - name: vault
    binaries:
      - name: vault
        mode: 0755
        src: https://releases.hashicorp.com/vault/0.10.0/vault_0.10.0_linux_amd64.zip
        src_hash: 1234567890123456789012345678901234567890 
        format: zip
    files:
      - path: /etc/vault/config.hcl
        mode: 0700
...
func TestConfigMd5(t *testing.T) {
	config := `
packages:
  - name: vault
    binaries:
      - name: vault
        mode: 0755
        src: https://releases.hashicorp.com/vault/0.10.0/vault_0.10.0_linux_amd64.zip
        src_hash: 12345678901234567890123456789012
        format: zip
    files:
      - path: /etc/vault/config.hcl
        mode: 0700
...
func TestConfigEmptyHash(t *testing.T) {
	config := `
packages:
  - name: vault
    binaries:
